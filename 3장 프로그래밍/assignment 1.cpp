...
`` 사용자 정의 함수를 호출하여 국어, 영어, 수학 성적을 매개변수로 전달하여 총점을 계산하고,
`` 평균은 계산된 총점으로 계산하여 출력하도록 하시오.
`` 이 때, 국어, 영어, 수학, 총점 평균을 위한 변수의 주소를 출력하고, 
`` 사용자 정의 함수에서 매개변수인 국어, 영어, 수학, 변수의 주소를 출력하시오.)
 */
#include <stdio.h>
